...
const About = () => {
    return <>
      ...
      <article>
        ...
        <p>
        LanaRosa es un emprendimiento colombiano dedicado al mundo del crochet, creado por amantes de las manualidades y el arte de tejer a mano. Con una pasión por las fibras naturales y los diseños únicos,<br />
        LanaRosa ofrece productos de crochet de alta calidad y confeccionados con cuidado.
...
<br />Cada pieza se crea con atención a los detalles y se diseñan teniendo en cuenta las últimas tendencias de la moda. <br />
...
min-width: 390px;
  ...
  article{
    background-image: url("https://i.ibb.co/HTWrpGD/Lanas1.jpg");
